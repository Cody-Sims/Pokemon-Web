...
export const ironvalePokemart: MapDefinition = {
  key: 'ironvale-pokemart', width: 9, height: 8, ground: g,
  encounterTableKey: '', isInterior: true, displayName: 'Ironvale Poké Mart',
  npcs: [{
    id: 'ironvale-clerk', tileX: 3, tileY: 2, textureKey: 'generic-trainer',
    facing: 'down', dialogue: ['Welcome to the Poké Mart!'], interactionType: 'shop',
  }],
  trainers: [],
  warps: [
    { tileX: 3, tileY: 7, targetMap: 'ironvale-city', targetSpawnId: 'from-pokemart' },
    { tileX: 4, tileY: 7, targetMap: 'ironvale-city', targetSpawnId: 'from-pokemart' },

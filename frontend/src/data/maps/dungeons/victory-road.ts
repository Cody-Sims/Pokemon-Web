...
export const victoryRoad: MapDefinition = {
  ...
  npcs: [
    ...
    { id: 'vr-vent-1', tileX: 4, tileY: 7, textureKey: 'sign-post', facing: 'down',
    ...
    { id: 'vr-vent-2', tileX: 20, tileY: 14, textureKey: 'sign-post', facing: 'down',
    ...
    { id: 'vr-vent-3', tileX: 6, tileY: 22, textureKey: 'sign-post', facing: 'down',
    ...
    { id: 'vr-vent-4', tileX: 18, tileY: 26, textureKey: 'sign-post', facing: 'down',
    ...
    { id: 'vr-vent-5', tileX: 12, tileY: 3, textureKey: 'sign-post', facing: 'down',

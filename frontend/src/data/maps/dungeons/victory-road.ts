...
export const victoryRoad: MapDefinition = {
  ...
  objects: [
    { id: 'victory-sign', tileX: 12, tileY: 33, textureKey: 'sign-post', objectType: 'sign',
      dialogue: ['VICTORY ROAD', 'Only trainers with 8 Badges may pass!'] },
    { id: 'vr-vent-1', tileX: 4, tileY: 7, textureKey: 'item-ball', objectType: 'item-ball',
    ...
    { id: 'vr-vent-2', tileX: 20, tileY: 14, textureKey: 'item-ball', objectType: 'item-ball',
    ...
    { id: 'vr-vent-3', tileX: 6, tileY: 22, textureKey: 'item-ball', objectType: 'item-ball',
    ...
    { id: 'vr-vent-4', tileX: 18, tileY: 26, textureKey: 'item-ball', objectType: 'item-ball',
    ...
    { id: 'vr-vent-5', tileX: 12, tileY: 3, textureKey: 'item-ball', objectType: 'item-ball',

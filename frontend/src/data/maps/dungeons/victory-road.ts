...
export const victoryRoad: MapDefinition = {
  ...
  weather: 'fog',
  npcs: [
    { id: 'victory-sign', tileX: 12, tileY: 33, textureKey: 'generic-trainer', facing: 'up',
      dialogue: ['VICTORY ROAD', 'Only trainers with 8 Badges may pass!'] },
    // Volcanic Survey quest vents
    { id: 'vr-vent-1', tileX: 4, tileY: 7, textureKey: 'generic-trainer', facing: 'down',
    ...
    { id: 'vr-vent-2', tileX: 20, tileY: 14, textureKey: 'generic-trainer', facing: 'down',
    ...
    { id: 'vr-vent-3', tileX: 6, tileY: 22, textureKey: 'generic-trainer', facing: 'down',
    ...
    { id: 'vr-vent-4', tileX: 18, tileY: 26, textureKey: 'generic-trainer', facing: 'down',
    ...
    { id: 'vr-vent-5', tileX: 12, tileY: 3, textureKey: 'generic-trainer', facing: 'down',

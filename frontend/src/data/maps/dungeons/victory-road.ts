...
export const victoryRoad: MapDefinition = {
  ...
  objects: [
    ...
    { id: 'vr-vent-1', tileX: 4, tileY: 7, textureKey: 'vent', objectType: 'item-ball',
    ...
    { id: 'vr-vent-2', tileX: 20, tileY: 14, textureKey: 'vent', objectType: 'item-ball',
    ...
    { id: 'vr-vent-3', tileX: 6, tileY: 22, textureKey: 'vent', objectType: 'item-ball',
    ...
    { id: 'vr-vent-4', tileX: 18, tileY: 26, textureKey: 'vent', objectType: 'item-ball',
    ...
    { id: 'vr-vent-5', tileX: 12, tileY: 3, textureKey: 'vent', objectType: 'item-ball',

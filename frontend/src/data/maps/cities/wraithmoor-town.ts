...
export const wraithmoorTown: MapDefinition = {
  ...
  npcs: [
    ...
    { id: 'wraithmoor-memory-1', tileX: 11, tileY: 11, textureKey: 'sign-post', facing: 'down',
    ...
    { id: 'wraithmoor-memory-2', tileX: 4, tileY: 13, textureKey: 'sign-post', facing: 'down',
    ...
    { id: 'wraithmoor-memory-3', tileX: 16, tileY: 18, textureKey: 'sign-post', facing: 'down',

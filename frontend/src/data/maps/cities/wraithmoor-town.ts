...
export const wraithmoorTown: MapDefinition = {
  ...
  npcs: [
    ...
    { id: 'wraithmoor-npc', name: 'Townsperson', tileX: 7, tileY: 6, textureKey: 'npc-male-3', facing: 'left',
    ...
    { id: 'wraithmoor-ghost-girl', name: 'Ghost Girl', tileX: 11, tileY: 12, textureKey: 'npc-female-6', facing: 'down',
    ...
    { id: 'tutor-wraithmoor', name: 'Move Tutor', tileX: 8, tileY: 14, textureKey: 'npc-female-6', facing: 'left',

...
export const voltaraPokecenter: MapDefinition = {
  ...
  objects: [
    {
    id: 'voltara-pc', tileX: 9, tileY: 2, textureKey: 'item-ball', objectType: 'pc', dialogue: ['Someone\'s PC is booted up.', 'Access the Pokémon Storage System?'], interactionType: 'pc' }
  ],
  warps: [

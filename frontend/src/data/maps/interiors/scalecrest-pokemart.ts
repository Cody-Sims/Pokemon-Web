...
export const scalecrestPokemart: MapDefinition = {
  key: 'scalecrest-pokemart', width: 9, height: 8, ground: g,
  encounterTableKey: '', isInterior: true, displayName: 'Scalecrest Poké Mart',
  npcs: [{ id: 'scalecrest-clerk', tileX: 3, tileY: 2, textureKey: 'generic-trainer',
    facing: 'down', dialogue: ['Welcome to the Poké Mart!'], interactionType: 'shop' }],
  trainers: [],
  warps: [
    { tileX: 3, tileY: 7, targetMap: 'scalecrest-citadel', targetSpawnId: 'from-pokemart' },
    { tileX: 4, tileY: 7, targetMap: 'scalecrest-citadel', targetSpawnId: 'from-pokemart' },

...
export const ghostPokemon: Record<number, PokemonData> = {
  ...
  153: {
    ...
    abilities: ['pressure'],
    learnset: [
      { level: 1, moveId: 'lick' }, { level: 15, moveId: 'pursuit' },
      { level: 30, moveId: 'shadow-ball' }, { level: 40, moveId: 'dark-pulse' },
      { level: 50, moveId: 'nasty-plot' }, { level: 60, moveId: 'shadow-claw' },
      { level: 70, moveId: 'crunch' }, { level: 80, moveId: 'phantom-force' },
    ],
    evolutionChain: [],

...
export const dragonMoves: Record<string, MoveData> = {
  ...
  'dragon-dance': { id: 'dragon-dance', name: 'Dragon Dance', type: 'dragon', category: 'status', power: null, accuracy: 100, pp: 20, effect: { type: 'stat-change', target: 'self', stat: 'attack', stages: 1 } },

...
export const normalMoves: Record<string, MoveData> = {
  ...
  'smokescreen':  { id: 'smokescreen', name: 'Smokescreen', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 20, effect: { type: 'stat-change', target: 'enemy', stat: 'spAttack', stages: -1 } },
  'double-team':  { id: 'double-team', name: 'Double Team', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 15, effect: { type: 'stat-change', target: 'self', stat: 'spDefense', stages: 1 } },
  'minimize':     { id: 'minimize', name: 'Minimize', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 10, effect: { type: 'stat-change', target: 'self', stat: 'spDefense', stages: 2 } },
  'focus-energy': { id: 'focus-energy', name: 'Focus Energy', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 30, effect: { type: 'stat-change', target: 'self', stat: 'spAttack', stages: 1 } },

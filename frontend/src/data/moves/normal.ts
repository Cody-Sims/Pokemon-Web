...
export const normalMoves = {
  ...
  'giga-impact':  { id: 'giga-impact', name: 'Giga Impact', type: 'normal', category: 'physical', power: 150, accuracy: 90, pp: 5, effect: { type: 'two-turn', target: 'enemy', twoTurnMove: 'giga-impact', rechargeOnly: true } },
  ...
  'return':       { id: 'return', name: 'Return', type: 'normal', category: 'physical', power: 90, accuracy: 100, pp: 20 },
  'facade':       { id: 'facade', name: 'Facade', type: 'normal', category: 'physical', power: 70, accuracy: 100, pp: 20 },
  ...
  'tri-attack':   { id: 'tri-attack', name: 'Tri Attack', type: 'normal', category: 'special', power: 80, accuracy: 100, pp: 10, effect: { type: 'status', target: 'enemy', randomStatus: ['burn', 'freeze', 'paralysis'], chance: 20 } },
  ...
  'smokescreen':  { id: 'smokescreen', name: 'Smokescreen', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 20, effect: { type: 'stat-change', target: 'enemy', stat: 'accuracy', stages: -1 } },
  'double-team':  { id: 'double-team', name: 'Double Team', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 15, effect: { type: 'stat-change', target: 'self', stat: 'evasion', stages: 1 } },
  'minimize':     { id: 'minimize', name: 'Minimize', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 10, effect: { type: 'stat-change', target: 'self', stat: 'evasion', stages: 2 } },
  ...
  'attract':      { id: 'attract', name: 'Attract', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 15 },
  ...
  'flash':        { id: 'flash', name: 'Flash', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 20, effect: { type: 'stat-change', target: 'enemy', stat: 'accuracy', stages: -1 } },

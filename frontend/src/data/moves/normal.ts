...
export const normalMoves: Record<string, MoveData> = {
  ...
  'smokescreen':  { id: 'smokescreen', name: 'Smokescreen', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 20, effect: { type: 'stat-change', target: 'enemy', stat: 'speed', stages: -1 } },
  ...
  'flash':        { id: 'flash', name: 'Flash', type: 'normal', category: 'status', power: null, accuracy: 100, pp: 20, effect: { type: 'stat-change', target: 'enemy', stat: 'speed', stages: -1 } },

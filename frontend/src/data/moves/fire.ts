...
export const fireMoves = {
  ...
  'blast-burn':   { id: 'blast-burn', name: 'Blast Burn', type: 'fire', category: 'special', power: 150, accuracy: 90, pp: 5, effect: { type: 'two-turn', target: 'enemy', twoTurnMove: 'blast-burn', rechargeOnly: true } },
